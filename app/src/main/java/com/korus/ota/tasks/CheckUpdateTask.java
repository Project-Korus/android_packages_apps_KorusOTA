...
import com.korus.ota.MainActivity;
import com.korus.ota.R;
import com.korus.ota.configs.AppConfig;
import com.korus.ota.configs.LinkConfig;
import com.korus.ota.configs.OTAConfig;
import com.korus.ota.configs.OTAVersion;
import com.korus.ota.dialogs.WaitDialogHandler;
import com.korus.ota.utils.OTAUtils;
import com.korus.ota.xml.OTADevice;
...
public class CheckUpdateTask extends AsyncTask<Context, Void, OTADevice> {
    ...
    private void showNotification(Context context) {
        if (mIsBackgroundThread) {
            ...
            int notifyID = 1;
            String id = "korusota_channel";
            CharSequence name = context.getString(R.string.korus_channel);
            String description = context.getString(R.string.korus_channel_description);
